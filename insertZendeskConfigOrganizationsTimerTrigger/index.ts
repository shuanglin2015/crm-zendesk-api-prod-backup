...
const timerTrigger: AzureFunction = async function (context: Context, myTimer: any): Promise<void> {
    const log: Logger = context.log;
        log('HTTP trigger insertZendeskConfigOrganizationsTimerTrigger function processed a request.');
        ...
        try {
            ...
            const items = await searchService.retrieveData(log, updatedDateStart, updatedDateEnd, organizationId, null, endPage);
